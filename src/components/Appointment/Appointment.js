...
const Appointment = () => {
    ...
    return (
        <div className="container pb-5 mb-5">
            <h2 className="text-info pt-5 mt-3">Book An Appointment</h2>
            ...
            <div className="d-flex row row-cols-sm-1 row-cols-md-2 justify-content-center align-items-center p-5">
                ...
                <div className="">
                    <form action="" className="border border-3 border-info p-4">
                        ...
                        <button className="border  rounded bg-info  text-white fw-bold mt-4 px-3 py-2 btn disabled">Book Now</button>
                    </form>
                </div>
            </div>
        </div>
